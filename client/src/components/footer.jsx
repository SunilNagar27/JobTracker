    ...
    <div className='bg-neutral-950 text-neutral-200 py-4'>
      <div className='flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='flex flex-col md:flex-row items-center ml-4 gap-4 mb-4 md:mb-0'>
          ...
          <div className='border-l border-neutral-400 h-6 md:mx-4'></div> {/* Vertical separator */}
          <p className='text-sm'>
        ...
        <div className='flex flex-col md:flex-row items-center mr-5 gap-4 md:gap-6'>
          <a href='#' className='text-neutral-400 hover:text-teal-500'>Privacy Policy</a>
          <a href='#' className='text-neutral-400 hover:text-teal-500'>Terms of Service</a>
          <a href='#' className='text-neutral-400 hover:text-teal-500'>Contact Us</a>
        </div>
      </div>
    </div>
  );
